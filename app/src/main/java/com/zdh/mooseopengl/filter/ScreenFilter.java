...
public class ScreenFilter {
    ...
    public ScreenFilter(Context context) {
        ...
        // 创建着色器
        vertexShader = GLUtil.loadShaderAssets(context, GLES20.GL_VERTEX_SHADER, R.raw.camera_vert);
        fragShader = GLUtil.loadShaderAssets(context, GLES20.GL_FRAGMENT_SHADER, R.raw.camera_frag);
        // 链接
